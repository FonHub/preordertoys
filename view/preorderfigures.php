...
<head>
    <meta charset="utf-8">
    <title>Preordertoys PREORDER FIGURES </title>
...
<body class="page">
    <div class="page-wrapper">
        ...
        <main class="page-main">
            ...
            End banner
            ------------------------------->
            <div id="figures" class="section-figures">
                <div class="uk-container uk-container-expand">
                    <div class="uk-margin-large-bottom uk-grid-collapse" data-uk-grid>
                        ...
                        <div class="uk-width-4-5@l list-padding-large">
                            <div class="section-main ma-b20 ">
                                <?php include('../view/preorder-figures-home.php'); ?>
                            </div>
                            <div class="section-content">
                                <?php include('../view/preorderfigures-listall.php'); ?>
                            </div>
                        </div>
                    </div>
                </div>
