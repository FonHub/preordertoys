                                ...
                                <div class="uk-width-1-5@l  _sidebar">
                                    <aside class="sidebar">
                                        <div class="widjet widjet-time-work">
                                            <h4 class="widjet__title">พรีออเดอร์</h4>


                                            <ul class="uk-tab-left uk-tab" uk-tab="connect: #component-tab-left; animation: uk-animation-fade" aria-expanded="true">
                                                <li class="uk-active">
                                                    <div class="uk-button uk-button-widjet">เติมเงินรายการพรีออเดอร์</div>
                                                </li>
                                                <li>
                                                    <div class="uk-button uk-button-widjet">รายการพรีออเดอร์</div>
                                                </li>
                                                <li>
                                                    <div class="uk-button uk-button-widjet">รายการชำระค่าส่งพรีออเดอร์</div>
                                                </li>
                                ...
                                <div class="uk-width-4-5@l list-padding-large">
                                    <div>
                                        ...
                                        <ul id="component-tab-left" class="uk-switcher" style="touch-action: pan-y pinch-zoom;">
                                            <li class="uk-active">
                                                <div>
                                                    <h3>เติมเงินรายการพรีออเดอร์</h3>
                                                    <form>
                                                        <div class="uk-margin">
                                            ...
                                            <li>
                                                <div>
                                                    <h3>รายการพรีออเดอร์</h3>
                                                    <div class="blog-card__more"><a class="uk-button uk-button-default" href="souvenir.php" target="_blank">ดูรายการ</a></div>
                                                </div>
                                            </li>
                                            <li>
                                                <div>
                                                    <h3>รายการชำระค่าส่งพรีออเดอร์</h3>
                                                    <div class="blog-card__more"><a class="uk-button uk-button-default" href="payment-for-shipping.php" target="_blank">ดูรายการ</a></div>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
