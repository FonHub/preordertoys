...
.section-popular {
    display: block;
    position: relative;
    background-color: #cec3b2 !important;
}
...
.uk-table td {
    ...
    border-right: 20px solid #cec3b2;
    border-bottom: 10px solid#cec3b2;
}
.uk-table tbody tr {
    background: #eae0d6;
    border-bottom: 20px solid #d8e0cc;
...
<body class="page-home">
    <div class="page-wrapper">
        ...
        <main class="page-main">
            <!-- section-banner -->
            <?php include('../view/section-banner-admin.php'); ?>
                    ...
                    <div class="uk-margin-large-bottom uk-grid-collapse" data-uk-grid>
                        ...
                        <div class="uk-width-5-5@l list-padding-large">
                            <div class="section-content">
                                ...
                                <?php include('../view/auction-admin-all.php'); ?>
                            </div>
                        </div>
                    </div>
                </div>
