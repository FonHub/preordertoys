                        ...
                        <nav class="navbar navbar-expand-custom navbar-mainbg _mymenu_pc" style="height: 65px;">
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul class="navbar-nav ml-auto">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" href="MyDeposit.php"><i class="fas fa-calculator"></i>การมัดจำ </a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <div class="uk-width-1-5@l  _sidebar">
                                    <aside class="sidebar">
                                        <div class="widjet widjet-time-work">
                                            <h4 class="widjet__title">การมัดจำ</h4>


                                            <ul class="uk-tab-left uk-tab" uk-tab="connect: #component-tab-left; animation: uk-animation-fade" aria-expanded="true">
                                                <li class="uk-active">
                                                    <div class="uk-button uk-button-widjet">เติมเงินมัดจำ Figures</div>
                                                </li>
                                                <li>
                                                    <div class="uk-button uk-button-widjet">เติมเงินมัดจำ Resin</div>
                                                </li>
                                                <li class="uk-active">
                                                    <div class="uk-button uk-button-widjet">การมัดจำ Figures</div>
                                                </li>
                                                <li>
                                                    <div class="uk-button uk-button-widjet">การมัดจำ Resin</div>
                                                </li>
                                ...
                                <div class="uk-width-4-5@l list-padding-large">
                                    <div>
                                        ...
                                        <ul id="component-tab-left" class="uk-switcher" style="touch-action: pan-y pinch-zoom;">
                                            ...
                                            <li>
                                                <div>
                                                    <h3>การมัดจำ Figures</h3>
                                                    <div class="blog-card__more"><a class="uk-button uk-button-default" href="deposit-figures.php" target="_blank">ดูรายการ</a></div>
                                                </div>
                                            </li>
                                            <li>
                                                <div>
                                                    <h3>การมัดจำ Resin</h3>
                                                    <div class="blog-card__more"><a class="uk-button uk-button-default" href="deposit-resin.php" target="_blank">ดูรายการ</a></div>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
