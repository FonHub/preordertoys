                        ...
                        <nav class="navbar navbar-expand-custom navbar-mainbg _mymenu_pc" style="height: 65px;">
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul class="navbar-nav ml-auto">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" href="Myinstallment.php"><i class="far fa-calendar-alt"></i>การผ่อน </a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <div class="uk-width-1-5@l  _sidebar">
                                    <aside class="sidebar">
                                        <div class="widjet widjet-time-work">
                                            <h4 class="widjet__title">การผ่อน</h4>


                                            <ul class="uk-tab-left uk-tab" uk-tab="connect: #component-tab-left; animation: uk-animation-fade" aria-expanded="true">
                                                <li class="uk-active">
                                                    <div class="uk-button uk-button-widjet">เติมเงินการผ่อน Figures</div>
                                                </li>
                                                <li>
                                                    <div class="uk-button uk-button-widjet">เติมเงินการผ่อน Resin</div>
                                                </li>
                                                <li class="uk-active">
                                                    <div class="uk-button uk-button-widjet">การผ่อน Figures</div>
                                                </li>
                                                <li>
                                                    <div class="uk-button uk-button-widjet">การผ่อน Resin</div>
                                                </li>
                                ...
                                <div class="uk-width-4-5@l list-padding-large">
                                    <div>
                                        ...
                                        <ul id="component-tab-left" class="uk-switcher" style="touch-action: pan-y pinch-zoom;">
                                            ...
                                            <li>
                                                <div>
                                                    <h3>การผ่อน Figures</h3>
                                                    <div class="blog-card__more"><a class="uk-button uk-button-default" href="installment-figures.php" target="_blank">ดูรายการ</a></div>
                                                </div>
                                            </li>
                                            <li>
                                                <div>
                                                    <h3>การผ่อน Resin</h3>
                                                    <div class="blog-card__more"><a class="uk-button uk-button-default" href="installment-resin.php" target="_blank">ดูรายการ</a></div>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
